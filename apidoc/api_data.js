define({ "api": [
  {
    ...
    "title": "get an article from the database",
    "name": "articles",
    "group": "data",
    "description": "<p>gets an article from the database</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "/data/latestart:num",
    "title": "get the latest num articles",
    "name": "latestArticles",
    "group": "data",
    "description": "<p>get the latest articles from the database</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
